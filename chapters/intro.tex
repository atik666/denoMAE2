...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\textwidth]{images/flow_dia.png}
...
The remainder of this paper is organized as follows: Section II reviews related work in self-supervised learning and automatic modulation classification. Section III details our proposed DenoMAE2.0 architecture and methodology. Section IV describes the experimental setup, datasets, and implementation details. Section V presents our results on denoising performance, classification accuracy, and transfer learning capabilities. Section VI provides an ablation study analyzing the contribution of individual components. Finally, Section VII concludes the paper.
